...
const AboutPage = () => {
  ...
  useEffect(()=> {
    const handleScroll = ()=> {
      ...
      if(nameRef.current){
        nameRef.current.style.transform = `translateX(-${offsetY * 0.3}px)`;
        nameRef.current.style.color = `${offsetY !== 0 && '#aaa'}`;
      }
    }
    ...
    <section className="about-page">
      ...
      <div className={`container  ${scrollPosition > 0 ? "margin-top" : ""}`}>
        <div className="name-wrapper">
          ...
          <a className="download-link" download="download" href="/resume.pdf">
            <span>Download</span>
            <span>Resume</span>
          </a>
        </div>
