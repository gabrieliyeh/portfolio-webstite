    ...
    <footer className='footer'>
      <div className='container'>
        <p>
          ...
          <a className='mail-link' target='_blank' rel='noopener' href="mailto:gabrieliyeh95@gmail.com?subject=Lets work together! ;&body=Hello I think we need you to work on/collaborate this particular product...Reach out as soon as you can.">
            Contact me by mail
          </a>
